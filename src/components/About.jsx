...
const About = () => {
  return (
    <>
      ...
      >
        My goal throughout my academic career has always been to become a jack of all trades, hence my choice to study mechatronics. Since beginning my studies, I've worked in diverse roles in construction, smart buildings, and web services, and automotive. My passion for new innovations drives me to continue to learn as much as I can.
        <br/> &nbsp;
      </motion.p>
